import ControllerInchirieri from "../controller/ControllerInchirieri.js";
...
class Rent {
    ...
    constructor(id) {
        ...
        this.container.classList = "rent-cont";
        ...
        this.btnHome.addEventListener("click", this.handleReturnHome);
    ...
    createMain = () => {
        ...
        if (localStorage.getItem("logat") === "") {

            button.classList = "login-to";
            button.innerHTML = `Login to rent`;
            button.addEventListener("click", this.handleLoginToRent);

        } else {

            button.classList = "now";
            button.innerHTML = `RENT NOW`;
            button.addEventListener("click", this.handleRentDetails);
        }
