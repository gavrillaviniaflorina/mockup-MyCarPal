...
class RentDetails {
    ...
    constructor() {
        ...
        this.container.classList = "rentDetails";
        this.containerRoot.appendChild(this.container);

        this.createHeader();
        this.createMain();

        this.btnReturnHome = document.querySelector(".home-button");
        this.btnReturnHome.addEventListener("click", this.handleReturnHome)
    }

    createHeader = () => {
        let header = document.createElement("header");
        header.classList = "rentDetais-header";
        header.innerHTML = `
        <h3>MyCarPal</h3>
    ...
    createMain = () => {
        ...
        main.classList = "rentDetails-main";
        ...
        <article for="adress">Adress</article>
        <input id="adress">
    ...
    <section>
        ...
        <fieldset>
            <h3>Pay numerar</h3>
            <article>
                <input id="numerar" type="checkbox">
                <label for="numerar">Select for numerar Payment</label>
            </article>
        </fieldset>
