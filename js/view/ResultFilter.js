...
class Filter {
    constructor(brand, type) {
        ...
        this.btnHome = document.querySelector(".return-home");
        this.btnHome.addEventListener("click", this.handlerHome);
    ...
    createHeader = () => {
        ...
        header.classList = "header-filter";

        header.innerHTML = `
        <h3>MyCarPal</h3>
        <section class="settings">

            <svg class="return-home" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 122.88 114.45">
    ...
    createMain = () => {
        ...
        main.classList = "main-result-Filter";
    ...
    populateCars = () => {
        ...
        let list = controllerMasini.filterMasini(this.brand, this.type);


        let main = document.querySelector(".main-result-Filter");
    ...
    createButtons = () => {
        ...
        buttons.classList = "buttons-filter";
        buttons.innerHTML = `
<button>1</button>
<button>2</button>
<button>3</button>
