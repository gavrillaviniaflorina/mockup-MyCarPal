...
class Car {
    ...
    constructor(id) {
        ...
        this.container.classList = "car-mockup";
    ...
    createMain() {
        ...
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia earum velit a, voluptatum quasi soluta ratione quo itaque! Velit, nemo facere? Cum eligendi sed alias repellendus aut voluptas ipsum laborum!</p>


        <section class="mobile-widget">
            <h3>Performance</h3>
